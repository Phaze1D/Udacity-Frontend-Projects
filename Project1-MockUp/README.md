...
This project is about creating an HTML replica from a PDF file. It is meant to simulate the progress that happens when a designer creates a mockup of a web page, and a developer has to transform that mockup into correctly semantic HTML.
